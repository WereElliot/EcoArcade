...
Current behavior: when tracking is enabled, the extension opens its popup window when the browser starts and when a new tab is opened. This behavior should be reflected in the store listing and screenshots so reviewers and users can understand it before installation.

## Notes
- Keep the listing factual and avoid promotional claims that cannot be verified.
- Make sure screenshots show the popup, dashboard, site tracking, and quiz flow.
- If you keep the automatic popup behavior, disclose it clearly in Partner Center.
